...
class _MobileSelectionOverlayController implements _SelectionOverlayController {
  ...
  bool _isStartHandleAutoScrolling = false;
  ...
  bool _isEndHandleAutoScrolling = false;
  ...
  void _autoScrollWhenStartHandleDragging() {
    if (_isStartHandleAutoScrolling) {
      return;
    }
    _isStartHandleAutoScrolling = true;
    _runStartHandleAutoScrollLoop();
  }

  void _runStartHandleAutoScrollLoop() {
    Future.delayed(const Duration(milliseconds: 16), () {
  ...
  void _autoScrollWhenEndHandleDragging() {
    if (_isEndHandleAutoScrolling) {
      return;
    }
    _isEndHandleAutoScrolling = true;
    _runEndHandleAutoScrollLoop();
  }

  void _runEndHandleAutoScrollLoop() {
    Future.delayed(const Duration(milliseconds: 16), () {
